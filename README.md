...
- **Free evaluation sample** on GitHub (`1w`) · **11 timeframes** on [getdata.finance](https://getdata.finance/datasets/eurgbp) · **748** `1w` rows in the full archive
- Built for **backtesting**, **algorithmic trading** and **quantitative finance** workflows
- **Weekly refresh** — [getdata.finance](https://getdata.finance) every **Saturday, 8am UTC+0**; GitHub `1w` sample updated in sync

> **Sample on GitHub** · `EURGBP_1w.csv` (106 rows, `2024-09-05` -> `2026-09-10`, 12.09 KB). **Full archive on [getdata.finance](https://getdata.finance/datasets/eurgbp)** — **748** `1w` rows (full `1m`: 5,322,800), **11 timeframes**, `2012-05-17` -> `2026-09-10`.
...
| 1w rows | 106 | **748** |
| Size | 12.09 KB | full ZIP on [getdata.finance](https://getdata.finance/datasets/eurgbp) |
...
The complete **EURGBP** archive on **[getdata.finance](https://getdata.finance/datasets/eurgbp)** includes **11 OHLCV timeframes** (1m · 3m · 5m · 15m · 30m · 1H · 4H · 12H · 1D · 3D · 1W) — **748** rows at `1w`, plus all other timeframes in the same ZIP.
